...
namespace TinkoffWatcher_Api.Migrations
{
    ...
    [Migration("20220627185102_DiarySettingsAdded")]
    partial class DiarySettingsAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CharacteristicCharacteristicAnswer", b =>
                {
                    b.Property<Guid>("CharacteristicAnswersId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CharacteristicsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("CharacteristicAnswersId", "CharacteristicsId");

                    b.HasIndex("CharacteristicsId");

                    b.ToTable("CharacteristicCharacteristicAnswer");
                });
            ...
            modelBuilder.Entity("TinkoffWatcher_Api.Models.Entities.Characteristic", b =>
                {
                    ...
                    b.Property<Guid?>("CharacteristicQuestionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CharacteristicQuestionId");
            ...
            modelBuilder.Entity("TinkoffWatcher_Api.Models.Entities.CharacteristicAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CharacteristicAnswers");
                });

            modelBuilder.Entity("TinkoffWatcher_Api.Models.Entities.CharacteristicQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsMultipleValues")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("CharacteristicQuestions");
                });
            ...
            modelBuilder.Entity("TinkoffWatcher_Api.Models.Entities.DiarySettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TinkoffWatcher_Api.Models.Entities.Property", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CharacteristicCharacteristicAnswer", b =>
                {
                    b.HasOne("TinkoffWatcher_Api.Models.Entities.CharacteristicAnswer", null)
                        .WithMany()
                        .HasForeignKey("CharacteristicAnswersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TinkoffWatcher_Api.Models.Entities.Characteristic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TinkoffWatcher_Api.Models.Entities.Characteristic", b =>
                {
                    b.HasOne("TinkoffWatcher_Api.Models.Entities.CharacteristicQuestion", "CharacteristicQuestion")
                        .WithMany()
                        .HasForeignKey("CharacteristicQuestionId");
            ...
            modelBuilder.Entity("TinkoffWatcher_Api.Models.Entities.CharacteristicAnswer", b =>
                {
                    b.HasOne("TinkoffWatcher_Api.Models.Entities.CharacteristicQuestion", "CharacteristicQuestion")
                        .WithMany("CharacteristicAnswers")
                        .HasForeignKey("CharacteristicQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TinkoffWatcher_Api.Models.Entities.Feedback", b =>
                {
                    b.HasOne("TinkoffWatcher_Api.Models.Entities.Interview", "Interview")
                        .WithMany("Feedbacks")
                        .HasForeignKey("InterviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TinkoffWatcher_Api.Models.Entities.CharacteristicQuestion", b =>
                {
                    b.Navigation("CharacteristicAnswers");
                });
